...
export const Hero = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-center items-center bg-[var(--hero-background-color)] text-[var(--hero-text-color)]">
      <div className="min-h-screen w-full flex flex-col gap-8 max-w-7xl justify-center sm:items-center sm:text-center p-4">
        <h1 className="text-8xl font-extrabold">Let code do the work.</h1>
