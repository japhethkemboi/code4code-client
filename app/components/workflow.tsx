    ...
    <div className="flex flex-col min-h-screen py-20 justify-center items-center w-full">
      <div className="flex flex-col gap-10 min-h-screen justify-center p-4 w-full max-w-7xl">
        ...
        <div className="flex flex-col gap-4">
          <div className="text-[12rem] font-extrabold opacity-20 ml-auto">01</div>
        ...
        <div className="flex flex-col gap-4">
          <div className="text-[12rem] font-extrabold opacity-20">02</div>
        ...
        <div className="flex flex-col gap-4">
          <div className="text-[12rem] font-extrabold opacity-20 ml-auto">03</div>
          <p className="text-lg opacity-80 ml-auto">
        ...
        <Link href="/consult">
          <Button className="text-sm md:text-base w-auto" label="Create a lasting impact with us" />
        </Link>
      </div>
    </div>
  );
