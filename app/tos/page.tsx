  ...
  return (
    <div className="flex pt-24 flex-col items-center min-h-screen bg-gray-50 text-gray-900 p-6">
      ...
      <div className="max-w-4xl text-gray-700 space-y-6 text-lg">
        <p>
          Welcome to CODE4CODE. By accessing or using our services, you agree to comply with and be bound by the
          following Terms of Service.
        </p>
        <h2 className="text-2xl font-bold">1. Acceptance of Terms</h2>
        <p>
          By accessing our website or using our services, you acknowledge that you have read, understood, and agreed to
          these terms.
        </p>
        <h2 className="text-2xl font-bold">2. Intellectual Property</h2>
        <p>
          All content on this site, including text, graphics, logos, and software, is the property of CODE4CODE.
        ...
        <p>
          ...
          <a href="mailto:support@code4code.dev" className="text-indigo-600 underline">
            {" "}
